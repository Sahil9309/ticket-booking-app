export default function Perks ({selected,onChange}) {
    ...
    return(
        <>
        <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer accent-blue-500">
            <input type="checkbox" name="Free parking" onChange={handleCbClick} checked={selected.includes('Free parking')}/>
                ...
                <span>Free parking</span>
                    ...
                    <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer accent-blue-500">
                        <input type="checkbox" name="Air conditioning" onChange={handleCbClick} checked={selected.includes('Air conditioning')}/>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer accent-blue-500">
                        <input type="checkbox" name="Mini Theater" onChange={handleCbClick} checked={selected.includes('Mini Theater')}/>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
